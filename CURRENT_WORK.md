...
- **Backend API**: ~98% implemented — OIDC ✅, GC implementation present; destructive activation blocked by X1 alone (X2 closed 2026-08-13), Library Settings ✅, OnlyOffice ✅, Tags cascade ✅, Org Admin Panel ✅, Superadmin Departments ✅
- **Frontend UI**: ~83% functional (all modals migrated, folder icons ✅, ~51 ModalPortal wrappers to clean up)
- **Production Ready**: blocked for destructive GC until X1 closes (X2 closed 2026-08-13); keep `GC_ENABLED=false` on every replica/DC
