...
(`ISSUE-GC-UPLOAD-FENCE-REMATERIALIZATION-01`); the accepted-for-review, not-yet-frozen,
not-yet-implemented greenfield closure protocol for it is recorded in
