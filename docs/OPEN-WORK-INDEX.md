...
| `ISSUE-LIBRARY-HEAD-SERIAL-DOMAIN-01` | ✅ Closed 2026-09-03 | Both conditional HEAD publishes and initial-library conditional batches explicitly pin global `SERIAL`; `LOCAL_SERIAL` can no longer weaken this authority domain | Closed after W2a authority review; see [known issue](./KNOWN_ISSUES.md) |
