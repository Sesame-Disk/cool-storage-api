...
| `ISSUE-PUBLISH-REPAIR-DISCOVERY-SCALE-01` | MEDIUM (P2) | UNKNOWN repair rows are rediscovered by a full repair-bucket scan every minute; durable discovery needs a separately audited bounded design | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-discovery-scale-01) - provisional PR #206 |
...
| `ISSUE-LIBRARY-INITIAL-HEAD-CONCURRENCY-01` | HIGH (P1) | Concurrent sync initializers can observe an empty library HEAD and create competing initial commits without a conditional initializer authority | [known issue](./KNOWN_ISSUES.md#issue-library-initial-head-concurrency-01) · separate from W2/R31 |
| `ISSUE-PUBLISH-REPAIR-TIMEOUT-CLEANUP-01` | PARTIAL (P1 residual) | Shared W2 repair no longer treats lease expiry or timeout as cleanup authority; broader R31 publication continuity and other funnels remain open | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-timeout-cleanup-01) · R31/X1 follow-up |
| `ISSUE-PUBLISH-REPAIR-REACHABILITY-01` | HIGH (P1) | Repair HEAD reachability and unbounded ancestry can misclassify publication state across pre-CAS lease expiry and ambiguous/applied HEAD outcomes across DCs | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-reachability-01) · [R31](./GC-X1-PHYSICAL-LIFE-HANDOFF-PLAN.md#16-r31-remains-a-blocker-open) |
