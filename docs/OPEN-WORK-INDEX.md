...
|---|---|---|---|
| `ISSUE-RATE-LIMIT-UPLOAD-DOWNLOAD-01` | HIGH | Umbrella: **A1/A2 closed 2026-07-29; B closed 2026-07-30; C closed 2026-07-31; D1-D5 closed 2026-08-03** — D5 streams block GET through the canonical reader under `ProfileBlock` on the shared coordinator. **D6 remains open:** capacities/real-nginx slow-client evidence are not yet measured, **and** the shared pre-first-write admission gap (`ISSUE-DOWNLOAD-ADMISSION-PRE-FIRST-WRITE-GAP-01`) must close before the section can be enabled. | Readiness B4 ⊇ registry X10/X11 — **still the single-node blocker until D closes**; see [`SEAFHTTP-DOWNLOAD-ADMISSION-D0.md`](./SEAFHTTP-DOWNLOAD-ADMISSION-D0.md) |
