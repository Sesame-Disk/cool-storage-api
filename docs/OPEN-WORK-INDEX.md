...
|---|---|---|---|
| `ISSUE-RATE-LIMIT-UPLOAD-DOWNLOAD-01` | HIGH | Umbrella: **A1/A2 closed 2026-07-29; B closed 2026-07-30; C closed 2026-07-31; D2 closed 2026-08-02; D3 closed 2026-08-02** — D0 freezes the broader storage-backed byte-production scope, atomic multidimensional admission, stable link identity, writer lifetime and the D1-D6 PR sequence. **D4-D6 remain open; D1 coordinator/schema/metrics, D2 stable public-link download identity and D3 writer/gzip reachability are complete. The supported frontend disables both gzip and proxy buffering for D transfer locations, but no producer route is wired and no positive capacity has been measured.** | Readiness B4 ⊇ registry X10/X11 — **still the single-node blocker until D closes**; see [`SEAFHTTP-DOWNLOAD-ADMISSION-D0.md`](./SEAFHTTP-DOWNLOAD-ADMISSION-D0.md) |
