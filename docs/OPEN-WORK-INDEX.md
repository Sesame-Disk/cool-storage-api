...
| `ISSUE-PUBLISH-REPAIR-TIMEOUT-CLEANUP-01` | HIGH (P1) | Publish-repair lease expiry is not proof that an applied HEAD CAS did not publish; timeout is not destructive authority | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-timeout-cleanup-01) · R31/X1 follow-up |
