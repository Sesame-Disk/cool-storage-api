...
| `ISSUE-PUBLISH-REPAIR-REACHABILITY-01` | HIGH (P1) | Repair HEAD reachability and unbounded ancestry can misclassify post-HEAD publication state across DCs | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-reachability-01) · [R31](./GC-X1-PHYSICAL-LIFE-HANDOFF-PLAN.md#16-r31-remains-a-blocker-open) |
