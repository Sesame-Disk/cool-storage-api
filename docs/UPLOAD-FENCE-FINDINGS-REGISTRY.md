...
**X1 closure options:** [GC-X1-CLOSURE-OPTIONS.md](./GC-X1-CLOSURE-OPTIONS.md) — options, race matrix and recommended design. No option accepted yet; implementation not started.
...
that branch only; no part of it is a decision of record. X1 is now being closed on a
