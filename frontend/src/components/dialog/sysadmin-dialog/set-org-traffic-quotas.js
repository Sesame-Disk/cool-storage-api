                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">{gettext('Set organization quotas')}</h5>
                            <button type="button" className="close" onClick={this.props.toggleDialog} aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div className="modal-body">
                            {this.renderField(gettext('Storage quota'), storageInputValue, 'storageInputValue', gettext('0 means unlimited.'))}
...
SetOrgTrafficQuotasDialog.propTypes = propTypes;

export default SetOrgTrafficQuotasDialog;