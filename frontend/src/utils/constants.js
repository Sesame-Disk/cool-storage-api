...
export const subscriptionDetailsUrl = appConfig.subscriptionDetailsUrl || '';
...
export const canViewOrg = appPageOptions.canViewOrg === 'True';
...
export const orgMemberQuotaEnabled = orgPageOptions.orgMemberQuotaEnabled || '';
